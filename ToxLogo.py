...
try:
	...
	os.system("wget https://raw.githubusercontent.com/Toxic-Noob/PersonalRepository/main/PILLib.zip > /dev/null 2>&1")
	print("\n[!] Download Compleated, Installing Library...")
	os.system("unzip PILLib.zip > /dev/null 2>&1")
	os.system("rm -rf PILLib.zip && cd .Lib && cp -r * /data/data/com.termux/files/usr/lib/python3.9/site-packages")
	os.system("rm -rf .Lib")
